...
public class PublisherWelcomeScreen:EditorWindow
{
	...
	private void OnGUI()
	{
		...
		if (DrawButton(unityConnectIcon, "Unity Connect", "Our news page in English.")) 
			Process.Start("https://connect.unity.com/u/5813d29c0909150018ad9972");
		...
		if (DrawButton(vkIcon, "VK page", "Our news page (Russian and English).")) 
